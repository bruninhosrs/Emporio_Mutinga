  ...
  useEffect(() => {
    ...
    const fetchSupplier = async () => {
      try {
        ...
        console.log("Dados do fornecedor recebidos:", response);
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input
        ...
        onChange={(e) =>
          setSupplier({ ...supplier, fantasyName: e.target.value })
        }
      />
      <input
        type="text"
      ...
      <input
        ...
        onChange={(e) =>
          setSupplier({ ...supplier, contactName1: e.target.value })
        }
      />
      <input
        type="email"
        ...
        onChange={(e) =>
          setSupplier({ ...supplier, contactEmail1: e.target.value })
        }
      />
      <input
        type="text"
        ...
        onChange={(e) =>
          setSupplier({ ...supplier, contactPhone1: e.target.value })
        }
      />
      <input
        type="text"
        ...
        onChange={(e) =>
          setSupplier({ ...supplier, contactName2: e.target.value })
        }
      />
      <input
        type="email"
        ...
        onChange={(e) =>
          setSupplier({ ...supplier, contactEmail2: e.target.value })
        }
      />
      <input
        type="text"
        ...
        onChange={(e) =>
          setSupplier({ ...supplier, contactPhone2: e.target.value })
        }
      />
      <textarea
        value={supplier.paymentConditions || ""}
        onChange={(e) =>
          setSupplier({ ...supplier, paymentConditions: e.target.value })
        }
      />
      <textarea
        value={supplier.purchaseHistory || ""}
        onChange={(e) =>
          setSupplier({ ...supplier, purchaseHistory: e.target.value })
        }
      />
      <input
        type="number"
        ...
        onChange={(e) =>
          setSupplier({
            ...supplier,
            supplierRating: parseInt(e.target.value) || 0,
          })
        }
        min="1"
        max="5"
